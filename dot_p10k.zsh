# Generated by Powerlevel10k configuration wizard on 2021-08-07 at 09:44 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PYENV_BACKGROUND=69
  ...
  typeset -g POWERLEVEL9K_GO_VERSION_BACKGROUND=044
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|kubie|stern|tilt'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=125 #126
  ...
  # typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt|awsume'
